...
Revision ID: 26a30c252aec
Revises: ffdc0a98111c
Create Date: 2023-05-05 14:29:37.339383
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('owner', 'moderator', 'member'), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('channel', 'direct_message'), nullable=True),
    sa.Column('user_joined', sa.DateTime(), nullable=False),
    sa.Column('channel_id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    op.add_column('users', sa.Column('profile_image_url', sa.String(length=100), nullable=True))
    op.add_column('users', sa.Column('status', sa.Enum('online', 'offline', 'away'), nullable=True))
