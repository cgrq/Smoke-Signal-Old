...
Revision ID: 504ef65b9589
Revises: ffdc0a98111c
Create Date: 2023-05-06 10:58:07.841132
...
def upgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('status', sa.Enum('online', 'offline', 'away', name='Status'), nullable=True))
